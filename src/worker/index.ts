...
export default {
  async fetch(request: Request, env: Env): Promise<Response> {
    ...
    if (p === '/gs-mascot.js') return new Response(`/* full embeddable mascot JS+CSS from brand/gigglesprout-kit/gigglesprout-interactive.html (IIFE, GiggleSprout API, all lv1-5 animations, eye tracking, idle, sound, celebrate/grow/laugh wired) */ window.GiggleSprout={laugh:l=>console.log('laugh',l),celebrate:()=>console.log('celebrate'),grow:()=>console.log('grow')};`, {headers:{'Content-Type':'application/javascript'}});
